            ...
            >
                ...
                <List>
                    ...
                    <ListItem button>
                        ...
                        <Link to="/Reactions" style={{position: 'absolute', marginLeft: -16, display: 'block', width: '100%', height: '100%'}}/>
                    </ListItem>
                    <ListItem button>
                        <ListItemIcon>
                            <FontAwesomeIcon icon={faCommentDots} style={{width: 24, height: 24, color: 'rgb(27 146 216)'}}/>
                        </ListItemIcon>
                        <ListItemText>Comments</ListItemText>
                        <Link to="/Comments" style={{position: 'absolute', marginLeft: -16, display: 'block', width: '100%', height: '100%'}}/>
                    </ListItem>
                </List>
                <Divider />
                <List>
