...
{
    public class GetUserSubscriptionsByProfileIdQuery : IRequest<ICollection<GeneralUserProfileModel>>
    {
        ...
        public class Handler : IRequestHandler<GetUserSubscriptionsByProfileIdQuery, ICollection<GeneralUserProfileModel>>
        {
            ...
            public async Task<ICollection<GeneralUserProfileModel>> Handle(GetUserSubscriptionsByProfileIdQuery request, CancellationToken cancellationToken)
            {
